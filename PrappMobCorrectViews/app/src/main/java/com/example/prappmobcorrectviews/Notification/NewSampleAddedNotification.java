package com.example.prappmobcorrectviews.Notification;
...
/**
 * Helper class for showing and canceling new sample added
 * notifications.
 * <p>
 * This class makes heavy use of the {@link NotificationCompat.Builder} helper
 * class to create notifications in a backward-compatible way.
 */
public class NewSampleAddedNotification {
    /**
     * The unique identifier for this type of notification.
     */
    private static final String NOTIFICATION_TAG = "NewSampleAdded";
     ...
     * presentation of new sample added notifications. Make
     * sure to follow the
    ...
    public static void showNotify(final Context context,
        ...
        final NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                ...
                .setSmallIcon(R.drawable.ic_stat_new_sample_added)
